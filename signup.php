<?php
	...
	<tr><td>Your full name:</td><td><input id="login" type="text" name="login"></td></tr>
	<tr><td>Email address:<br><span>(This will be your login)</span></td><td><input id="login" type="text" name="login"></td></tr>
	<tr><td>Password:</td><td><input type="password" id="password" name="password"></td></tr>
	<tr><td>Password (confirm):</td><td><input type="password" id="password_confirm" name="password_confirm"></td></tr>
	<tr><td>Ladder Code:</td><td><input type="password" name="ladder_code"></td></tr>
	<?php if(isset($msg)) {?>
